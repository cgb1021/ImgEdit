...
function moveEvent(e) {
  ...
  var _sprite$getViewSize = sprite.getViewSize(state),
...
function _align(pos, canvas, state) {
  ...
  var _sprite$getViewSize2 = sprite.getViewSize(state),
...
var Sprite = function () {
  ...
  (0, _createClass3.default)(Sprite, [{
    ...
    key: 'getViewSize',
    value: function getViewSize(state) {
...
var ImgEdit = function () {
  ...
  (0, _createClass3.default)(ImgEdit, [{
    ...
    value: function scale(s, wheel) {
      ...
      var _sprite$getViewSize3 = sprite.getViewSize(state),
          width = _sprite$getViewSize3.width,
          height = _sprite$getViewSize3.height;
    ...
    value: function cut(rw, rh) {
      ...
      switch (sprite.angle) {
        ...
        case 1.5:
          if (sprite.angle === .5) {
            var _ref7 = [ry, sprite.height - rx - rw];
            rx = _ref7[0];
            ry = _ref7[1];
          } else {
            var _ref8 = [sprite.width - ry - rh, rx];
            rx = _ref8[0];
            ry = _ref8[1];
          }
          var _ref9 = [rh, rw];
          ...
          break;
        case 1:
          var _ref10 = [sprite.width - rw - rx, sprite.height - rh - ry];
          rx = _ref10[0];
          ry = _ref10[1];
    ...
    value: function resize(width, height) {
      ...
      var _sprite$getSize2 = sprite.getSize(),
          sWidth = _sprite$getSize2.width,
          sHeight = _sprite$getSize2.height;
    ...
    value: function setRange(width, height) {
      ...
      var _sprite$getSize4 = sprite.getSize(),
          iw = _sprite$getSize4.width,
          ih = _sprite$getSize4.height;
