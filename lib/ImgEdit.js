...
function _align(pos, canvas, state) {
  var sWidth = state.width * state.viewScale * state.scale;
  var sHeight = state.height * state.viewScale * state.scale;
  switch (pos) {
    case 'top':
    case 1:
      state.event.cy = 0;
...
function _draw(canvas, state, img) {
  ...
  if (img) {
    // 坐标转换
    var ratio = state.viewScale * state.scale;
    var sWidth = state.width * ratio;
    var sHeight = state.height * ratio;
    switch (state.angle) {
      case 0.5:
        // 顺时针90°
...
var ImgEdit = function () {
  ...
  (0, _createClass3.default)(ImgEdit, [{
    ...
    value: function rotate(angle) {
      ...
      var ratio = state.viewScale * state.scale * .5;
      ...
      if (state.range.width) {
        ...
        var iw = state.width * state.scale;
        var ih = state.height * state.scale;
        if (state.angle === .5 || state.angle === 1.5) {
          ;
          var _ref10 = [ih, iw];
          iw = _ref10[0];
    ...
    value: function setRange(width, height) {
      ...
      x >>= 0;
      y >>= 0;
      var iw = state.width * state.scale >> 0;
      var ih = state.height * state.scale >> 0;
      if (state.angle === .5 || state.angle === 1.5) {
        var _ref14 = [ih, iw];
        iw = _ref14[0];
        ih = _ref14[1];
...
var resize = exports.resize = function () {
  var _ref15 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(img, width, height) {
    var mime, edit;
...
var cut = exports.cut = function () {
  var _ref16 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(img, width, height, x, y) {
    var mime, edit;
...
var rotate = exports.rotate = function () {
  var _ref17 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(img, deg) {
    var mime, edit;
