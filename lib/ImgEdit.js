...
exports.cut = exports.resize = exports.fetchImg = undefined;
  ...
  if (img) {
    ...
    switch (state.angle) {
      case 0.5:
        ...
        var _ref2 = [eventData.ry, canvas.width - eventData.rx - eventData.rw, eventData.rh, eventData.rw];
        state.range.rx = _ref2[0];
        state.range.ry = _ref2[1];
        state.range.rw = _ref2[2];
        state.range.rh = _ref2[3];
      ...
      case 1.5:
        ...
        var _ref3 = [canvas.height - eventData.ry - eventData.rh, eventData.rx, eventData.rh, eventData.rw];
        state.range.rx = _ref3[0];
        state.range.ry = _ref3[1];
        state.range.rw = _ref3[2];
        state.range.rh = _ref3[3];
      ...
      case 1:
        ...
        var _ref4 = [canvas.width - eventData.rx - eventData.rw, canvas.height - eventData.ry - eventData.rh, eventData.rw, eventData.rh];
        state.range.rx = _ref4[0];
        state.range.ry = _ref4[1];
        state.range.rw = _ref4[2];
        state.range.rh = _ref4[3];
      ...
      default:
        ...
        var _ref5 = [eventData.rx, eventData.ry, eventData.rw, eventData.rh];
        state.range.rx = _ref5[0];
        state.range.ry = _ref5[1];
        state.range.rw = _ref5[2];
        state.range.rh = _ref5[3];
...
var ImgEdit = function () {
  ...
  (0, _createClass3.default)(ImgEdit, [{
    ...
    key: "draw",
    value: function draw() {
      _draw(data[this].img, this.canvas, data[this]);
      return this;
    }
  }, {
    key: "toDataURL",
    ...
    value: function scale(_scale) {
      ...
      if (x > 0 && y > 0 && state.offsetX < state.cx + state.width * state.ratio * state.viewScale && state.offsetY < state.cy + state.height * state.ratio * state.viewScale) {
        eventData.cx -= (eventData.offsetX - eventData.cx) / (state.viewScale - _scale) * _scale;
        eventData.cy -= (eventData.offsetY - eventData.cy) / (state.viewScale - _scale) * _scale;
      }
      ...
      if (!rw || !rh) {
        ...
        if (state.angle) {
          switch (state.angle) {
            ...
            case 1.5:
              if (state.angle === .5) {
                var _ref7 = [ry, state.height - rx - rw];
                rx = _ref7[0];
                ry = _ref7[1];
              } else {
                var _ref8 = [state.width - ry - rh, rx];
                rx = _ref8[0];
                ry = _ref8[1];
              }
              ...
              break;
            default:
              var _ref10 = [state.width - rw - rx, state.height - rh - ry];
              rx = _ref10[0];
              ry = _ref10[1];
...
var resize = exports.resize = function () {
  var _ref12 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(img, width, height) {
    var mime, edit;
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            mime = img.type;
            edit = new ImgEdit(document.createElement('canvas'));
