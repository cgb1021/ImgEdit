...
var Sprite = function () {
  ...
  (0, _createClass3.default)(Sprite, [{
    ...
    value: function getSize() {
      var _ref3 = this.angle === .5 || this.angle === 1.5 ? [this.height * this.scale, this.width * this.scale] : [this.width * this.scale, this.height * this.scale],
    ...
    value: function getViewSize(viewScale) {
      ...
      var _ref5 = this.angle === .5 || this.angle === 1.5 ? [this.height * ratio, this.width * ratio] : [this.width * ratio, this.height * ratio],
    ...
    value: function cut(rw, rh, rx, ry, viewScale) {
      ...
      switch (this.angle) {
        ...
        case 1.5:
          if (this.angle === .5) {
            var _ref7 = [ry, this.height - rx - rw];
            rx = _ref7[0];
            ry = _ref7[1];
          } else {
            var _ref8 = [this.width - ry - rh, rx];
            rx = _ref8[0];
            ry = _ref8[1];
          }
          var _ref9 = [rh, rw];
          ...
          break;
        case 1:
          var _ref10 = [this.width - rw - rx, this.height - rh - ry];
          rx = _ref10[0];
          ry = _ref10[1];
...
var ImgEdit = function () {
  ...
  (0, _createClass3.default)(ImgEdit, [{
    ...
    key: 'open',
    value: function () {
      var _ref11 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(file) {
        var img, state;
    ...
    value: function rotate(angle) {
      ...
      if (state.range.width) {
        ...
        switch (diff) {
          ...
          case -1.5:
          case .5:
            var _ref12 = [ih - height - y, x, height, width];
            x = _ref12[0];
            y = _ref12[1];
            width = _ref12[2];
            height = _ref12[3];
          ...
          case -.5:
          case 1.5:
            var _ref13 = [y, iw - width - x, height, width];
            x = _ref13[0];
            y = _ref13[1];
            width = _ref13[2];
            height = _ref13[3];
          ...
          // 平翻
          default:
            var _ref14 = [iw - width - x, ih - height - y];
            x = _ref14[0];
            y = _ref14[1];
