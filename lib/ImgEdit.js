...
var ImgEdit = function () {
  ...
  (0, _createClass3.default)(ImgEdit, [{
    ...
    value: function cut(rw, rh) {
      ...
      if (!rw || !rh) {
        // 以画布坐标为参考
        var xEnd = state.cx + state.width * state.viewScale;
        var yEnd = state.cy + state.height * state.viewScale;
...
var cut = exports.cut = function () {
  var _ref14 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(img, width, height, x, y) {
    var mime, edit;
...
var rotate = exports.rotate = function () {
  var _ref15 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(img, deg) {
    var mime, edit;
