...
function moveEvent(e) {
  ...
  var _sprite$getSize = sprite.getSize(state),
      iw = _sprite$getSize.width,
      ih = _sprite$getSize.height;
...
function stateChange(state, type) {
  if (state.onChange) {
    ...
    var sprite = state.sprite;
    var width = sprite.width * sprite.scale >> 0;
    var height = sprite.height * sprite.scale >> 0;
...
function _align(pos, canvas, state) {
  ...
  var _sprite$getSize2 = sprite.getSize(state),
      width = _sprite$getSize2.width,
      height = _sprite$getSize2.height;
...
function _draw(canvas, state) {
  ...
  if (sprite) {
    // 坐标转换
    var ratio = state.viewScale * sprite.scale;
    var width = sprite.width * ratio;
    var height = sprite.height * ratio;
    var cx = void 0,
        cy = void 0;
    switch (sprite.angle) {
      case 0.5:
...
function save(state, method) {
  ...
  var dWidth = canvas.width = width * sprite.scale;
  var dHeight = canvas.height = height * sprite.scale;
  if (sprite.angle) {
    if (sprite.angle !== 1) {
...
var Sprite = function () {
  ...
  (0, _createClass3.default)(Sprite, [{
    ...
    value: function getSize(state) {
      var ratio = state.viewScale * this.scale;

      var _ref3 = this.angle === .5 || this.angle === 1.5 ? [this.height * ratio, this.width * ratio] : [this.width * ratio, this.height * ratio],
...
var ImgEdit = function () {
  ...
  (0, _createClass3.default)(ImgEdit, [{
    ...
    value: function scale(s, wheel) {
      ...
      var _sprite$getSize3 = sprite.getSize(state),
          width = _sprite$getSize3.width,
          height = _sprite$getSize3.height;
    ...
    value: function cut(rw, rh) {
      ...
      switch (sprite.angle) {
        ...
        case 1.5:
          if (sprite.angle === .5) {
            var _ref6 = [ry, sprite.height - rx - rw];
            rx = _ref6[0];
            ry = _ref6[1];
          } else {
            var _ref7 = [sprite.width - ry - rh, rx];
            rx = _ref7[0];
            ry = _ref7[1];
          }
          var _ref8 = [rh, rw];
          ...
          break;
        case 1:
          var _ref9 = [sprite.width - rw - rx, sprite.height - rh - ry];
          rx = _ref9[0];
          ry = _ref9[1];
      ...
      if (rx >= sprite.width || ry >= sprite.height) return this;
      var x = void 0,
          y = void 0,
          width = void 0,
          height = void 0;
      ...
      (0, _assign2.default)(sprite, { x: x, y: y, width: width, height: height });
      this.clean(1);
      this.canvas && _draw(this.canvas, state);
    ...
    value: function resize(width, height) {
      ...
      if (!state.sprite) return this;
      var sprite = state.sprite;
      var sWidth = sprite.width * sprite.scale;
      var sHeight = sprite.height * sprite.scale;
      if (sprite.angle && sprite.angle !== 1) {
    ...
    value: function rotate(angle) {
      ...
      var diff = angle - sprite.angle;

      var _ref11 = sprite.angle === .5 || sprite.angle === 1.5 ? [sprite.height * sprite.scale, sprite.width * sprite.scale] : [sprite.width * sprite.scale, sprite.height * sprite.scale],
    ...
    value: function setRange(width, height) {
      ...
      var _ref16 = sprite.angle === .5 || sprite.angle === 1.5 ? [sprite.height * sprite.scale >> 0, sprite.width * sprite.scale >> 0] : [sprite.width * sprite.scale >> 0, sprite.height * sprite.scale >> 0],
