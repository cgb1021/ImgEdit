...
function moveEvent(e) {
  ...
  switch (e.type) {
    ...
    case 'mousemove':
      if (eventData.active) {
        if (ctrlKey) {
          var ratio = state.scale / state.viewScale;
          var _state$event = state.event,
              cx = _state$event.cx,
              cy = _state$event.cy;

          var iw = state.width / ratio;
          var ih = state.height / ratio;
          ...
          if (x + width > cx && y + height > cy && x < cx + iw && y < cy + ih) {
            x -= cx;
            y -= cy;
            (0, _assign2.default)(state.range, { width: width * ratio >> 0, height: height * ratio >> 0, x: x * ratio >> 0, y: y * ratio >> 0 });
...
function stateChange(state, type) {
  if (state.onChange) {
    ...
    state.onChange({ width: width, height: height, viewScale: state.viewScale.toFixed(2), range: { x: rangeX, y: rangeY, width: rw, height: rh }, type: type });
  }
}
// 设置对齐
...
function save(img, state, method) {
  ...
  if (state.angle) {
    if (state.angle !== 1) {
      var _ref3 = [canvas.height, canvas.width];
      // state.angle = .5, 1.5
...
var ImgEdit = function () {
  ...
  (0, _createClass3.default)(ImgEdit, [{
    ...
    key: "open",
    value: function () {
      var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(file) {
        var state;
    ...
    value: function toBlob(mime, quality) {
      ...
      return new _promise2.default(function (resolve) {
        if (!_this2.img) {
          ...
          save(_this2.img, data[_this2._id], 'toBlob', function (res) {
            resolve(res);
          }, mime, quality);
        }
      });
    ...
    value: function scale(_scale) {
      ...
      if ((state.offsetX || state.offsetY) && state.offsetX - state.cx > 0 && state.offsetY - state.cy > 0 && state.offsetX < state.cx + state.width * viewScale && state.offsetY < state.cy + state.height * viewScale) {
        // 在图片范围内，以鼠标位置为中心
        ...
        // 以图片在画布范围内中心点
        if (state.angle === .5 || state.angle === 1.5) {
          state.event.cx -= state.height * _scale * .5;
          state.event.cy -= state.width * _scale * .5;
        } else {
          state.event.cx -= state.width * _scale * .5;
          state.event.cy -= state.height * _scale * .5;
        }
      }
      this.canvas && _draw(this.canvas, state, this.img);
    ...
    value: function cut(rw, rh) {
      ...
      if (!rw || !rh) {
        ...
        rx = _state$range3.x;
        ry = _state$range3.y;
        rw = _state$range3.width;
        rh = _state$range3.height;
      } else {
        // 以图片坐标为参考
        rw = rw >> 0;
        rh = rh >> 0;
      ...
      switch (state.angle) {
        ...
        case 1.5:
          if (state.angle === .5) {
            var _ref5 = [ry, state.height - rx - rw];
            rx = _ref5[0];
            ry = _ref5[1];
          } else {
            var _ref6 = [state.width - ry - rh, rx];
            rx = _ref6[0];
            ry = _ref6[1];
          }
          var _ref7 = [rh, rw];
          ...
          break;
        case 1:
          var _ref8 = [state.width - rw - rx, state.height - rh - ry];
          rx = _ref8[0];
          ry = _ref8[1];
...
var resize = exports.resize = function () {
  var _ref10 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(img, width, height) {
    var mime, edit;
...
var cut = exports.cut = function () {
  var _ref11 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(img, width, height, x, y) {
    var mime, edit;
  ...
  return function cut(_x10, _x11, _x12, _x13, _x14) {
    return _ref11.apply(this, arguments);
  };
}();
var rotate = exports.rotate = function () {
  var _ref12 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(img, deg) {
    var mime, edit;
  ...
  return function rotate(_x15, _x16) {
